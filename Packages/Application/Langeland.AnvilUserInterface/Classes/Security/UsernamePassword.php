 ...
 */
class UsernamePassword extends \Neos\Flow\Security\Authentication\Token\UsernamePassword
{
    /**
    ...
    public function updateCredentials(ActionRequest $actionRequest)
    {
        ...
        $unit = ObjectAccess::getPropertyPath($arguments, '__authentication.Neos.Flow.Security.Authentication.Token.UsernamePassword.unit');
        ...
        if (!empty($username) && !empty($password) && !empty($unit)) {
            $this->credentials['username'] = $unit . '_' . $username;
